 ...
 *       Filename:  i_fbne.c
 *
 *    Description:  Implementation of the FBNE instruction
 *
 *        Version:  1.0
...
#define FBNE_CYCLES    1
#define FBNE_CODE_MASK 0x03800000
#define PRIVILEDGE  0
...
static int disassemble(uint32 instr, void *state)
{
    ...
    if( (instr & FBNE_CODE_MASK) && (op == OP) && (cond == COND) && (fmt = FMT))
    {
