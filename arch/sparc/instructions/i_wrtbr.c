 ...
 *       Filename:  i_wrtbr.c
 *
 *    Description:  Implementst the WRTBR SPARC instruction
 *
 *        Version:  1.0
...
31-30  29-25   24-19     18-14    13        12-5          4-0
+----+-------+--------+------------------------------------------+
| 10 | 00000 | 110011 |   rs1   | i=0 |   non-used   |    rs2    |
+----+-------+--------+------------------------------------------+
...
#define WRTBR_CYCLES    1
#define WRTBR_CODE_MASK 0x81980000
#define PRIVILEDGE  1
...
static int disassemble(uint32 instr, void *state)
{
    ...
    if( (instr & WRTBR_CODE_MASK) && (op == OP) && (op3 == OP3) )
    {
