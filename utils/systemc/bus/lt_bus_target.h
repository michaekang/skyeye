#ifndef __LT_BUS_TARGET_H__
#define __LT_BUS_TARGET_H__
...
class Lt_bus_target:public sc_core::sc_module{
public:
	//Lt_bus_target();
	Lt_bus_target(sc_core::sc_module_name module_name);
	~Lt_bus_target();
#if 1
	/*blocking transport*/
	...
	tlm_utils::simple_target_socket<Lt_bus_target> target_socket;
#endif	
};
