...
*/
/**
* @file lt_core_initiator.cpp
* @brief The core initiator transport
* @author Michael.Kang blackfin.kang@gmail.com
* @version 7849
* @date 2013-05-07
*/

#include "lt_core_initiator.h"

Lt_core_initiator::Lt_core_initiator(sc_core::sc_module_name module_name)
:sc_module   (module_name)
,initiator_socket("initiator_socket")
{
	gp_ptr = new tlm::tlm_generic_payload();
}
Lt_core_initiator::~Lt_core_initiator()
{
}


int Lt_core_initiator::bus_read (short size, generic_address_t addr, uint32_t * value)
{
...
int Lt_core_initiator::bus_write(short size, generic_address_t addr, uint32_t value)
{
...
void Lt_core_initiator::initiator_thread( tlm::tlm_generic_payload * transaction_ptr)
{
